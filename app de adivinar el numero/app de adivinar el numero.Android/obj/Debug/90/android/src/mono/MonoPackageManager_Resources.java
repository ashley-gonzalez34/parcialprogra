...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "app de adivinar el numero.Android.dll" comes first in this list. */
		"app de adivinar el numero.Android.dll",
		"app de adivinar el numero.dll",
		"FormsViewGroup.dll",
